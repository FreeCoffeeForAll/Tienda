...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    @Bean    // @Bean -> es como el autowire que inyectaba dependencias,
            //pero inyectamos dependencias pero de configuracion que debe hacer el programa cuando se esta ejecutando
